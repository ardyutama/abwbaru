				...
				<div className="center-content">
					<div className="form pa3 br3 shadow-5 ">
						<div data-toggle="buttons">
							<label className="f4 link mr3 ph3 pv2 dib white bg-mid-gray br3 mb2" onClick={this.onClickShowUrl}>
						...
						<button className="white b mr2 pv2 ph3 bn br2" onClick={onButtonSubmit} disabled={disableFind}>Find face</button>
